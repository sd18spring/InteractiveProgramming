...
class Model(object):
    ...
    def update(self):
        ...
        self.paddle.update()
        self.paddle2.update()
        if self.puck.x==(self.paddle.x+10) and self.puck.y==(self.paddle.y):
            self.puck.vx=-self.puck.vx
            self.puckvy=-self.puck.vy
        if self.puck.x==(self.paddle2.x+10) and self.puck.y==(self.paddle2.y):
            self.puck.vx=-self.puck.vx
...
class Puck(object):
    ...
    def __init__(self,x,y,height,width):
        ...
        self.vx=random.choice([-1,-.8,-.6,-.4,-.2,.2,.4,.6,.8,1])
        self.vy=random.choice([-1,-.8,-.6,-.4,-.2,.2,.4,.6,.8,1])
