...
//		display1 = "display: none;";
		...
		image = '"../graphics/population/' + countrycode.toUpperCase() + '_popgraph 2013.bmp" class="populationFit"';
		display = "";
		display1 = "display: none;";
		...
		addClass = '';
		hrefprint = '"../graphics/population/' + countrycode.toUpperCase() + '_popgraph 2013.bmp" target="blank"';
	}
